...
// Shapes
const spaceshipMesh = {
  vertices: myShip.vertices[0].values,
  indices: myShip.connectivity[0].indices,
  normals: myShip.vertices[1].values,
  texcoord: null
};
...
export function init(gl, program) {
  if (!gl) {
  ...
  document.onkeydown = function (ev) {
    ...
    //   let canvas = document.getElementById("gl-canvas");
      ...
      const myShip = {
        vao: setUpVertexObject(spaceshipMesh, true, gl, program),
      ...
      const volcano = {
        ...
        vao: setUpVertexObject(v1, true, gl, program),
        indices: v1.indices,
        transform() {
          return translate(400.0, 200.0, -1400);
        },
        material: gold,
        textured: 2.0
      };
      ...
      const earth = {
        ...
        vao: setUpVertexObject(v2, true, gl, program),
        indices: v2.indices,
        transform() {
          return translate(-700.0, 0.0, -3500);
        },
        material: gold,
        textured: 3.0
      };
      ...
      const gas = {
        ...
        vao: setUpVertexObject(v3, true, gl, program),
        indices: v3.indices,
        transform() {
          return translate(500.0, 200.0, -4000);
        },
        material: gold,
        textured: 4.0
      };
      ...
      const ring = {
        vao: setUpVertexObject(ringMesh, false, gl, program),
      ...
      const finishLine = {
        vao: setUpVertexObject(finishLineMesh, true, gl, program),
